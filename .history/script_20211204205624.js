...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    //In each call, print remining time to UI
...
// const oddEvenChecker = num => (num % 2 === 0 ? 'even' : 'odd');

// console.log(oddEvenChecker(70));
...
// //2
// console.log(new Date('Feb 04 2021 18:46:03'));
...
// const ingredients = ['spinach', 'cheese'];
